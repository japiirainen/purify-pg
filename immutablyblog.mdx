---
title: Easily create immutable data structures with TypeScript.
slug: 04-immutable-ts
author: Joona Piirainen
date: 09-12-2020
readTime: 4min
mainImage: https://images.unsplash.com/photo-1547433092-43c05df0c6ca?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=2689&q=80
blogpost: true
intro: Creating immutable data structures in pure typescript. I only recently found out about this feature, and thought that other people might have also missed out so I thought i'd make a quick blog post about it.
---

# Why would you want immutable data structures?

Immutable data structures are essential when you try to code in a functional way, and JavaScript by itself doesn't support these natively. Luckily we can leverage the type system provided by TypeScript to enforce these immutability rules on our frequently used data structures like arrays and objects.
...
We can luckily fix this by just giving xs the type **_ReadOnlyArray<T>_**.
